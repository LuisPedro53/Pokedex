  ...
  pokemons.map(function (valores) {
    ...
    <div class="pokemon-box">
      <div class = "div-nomePokemon">
        <p class = "nome-pokemon">` +
      valores.nome +
      `</p>
      </div>
      <img class = "imagem-pokemon" src="` +
      valores.imagem +
      `"  data-id="` +
      valores.id +
      `">
      ...
      <div class = "div-sobrePokemon">
        <p class = "sobre-pokemon" id = "life"> Life: ` +
      valores.experiencia +
      ` Hp</p>
        <p class = "sobre-pokemon" id = "Altura"> Height: ` +
      valores.altura +
      ` m</p>
        <p class = "sobre-pokemon" id = "Largura"> Weight: ` +
      valores.largura +
      ` Kg</p>
      </div> 
    </div>`;
